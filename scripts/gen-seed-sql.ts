...
const values = SEED_PRODUCTS.map(
  (p) =>
    ...
    `${p.isGym}, ${p.isOffer}, ${p.isOutOfStock}, ${p.sortOrder})`,
).join(",\n");
...
on conflict (slug) do update set
  ...
  is_gym = excluded.is_gym, is_offer = excluded.is_offer,
